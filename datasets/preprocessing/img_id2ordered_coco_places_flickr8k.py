...
if __name__ == "__main__":
    ...
    if args.dataset == 'coco':
        ...
        train_audio_dataset_json_file="/worktmp2/hxkhkh/current/FaST/data/coco_pyp/SpokenCOCO/SpokenCOCO_train_unrolled_karpathy.json"
        val_audio_dataset_json_file = "/worktmp2/hxkhkh/current/FaST/data/coco_pyp/SpokenCOCO/SpokenCOCO_val_unrolled_karpathy.json"
        ...
        train_imgid2ordered_file = "/worktmp2/hxkhkh/current/FaST/data/coco_pyp/SpokenCOCO/SpokenCOCO_train_imgid2ordered_indices.pkl"
        val_imgid2ordered_file = "/worktmp2/hxkhkh/current/FaST/data/coco_pyp/SpokenCOCO/SpokenCOCO_val_imgid2ordered_indices.pkl"
