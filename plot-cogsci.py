...
m7base3T = (np.reshape(scores_m7base3T, (5,8))).T
...
m7ver4 = (np.reshape(scores_m7ver4, (9,8))).T
################################################################ Plotting
...
plt.subplot(3, 4, 6)  
plt.plot(m7base3T[0], label='layer1')
plt.plot(m7base3T[1], label='layer2')
plt.plot(m7base3T[2], label='layer3')
plt.plot(m7base3T[3], label='layer4')
plt.plot(m7base3T[4], label='layer5')
plt.plot(m7base3T[5], label='layer6')
plt.plot(m7base3T[6], label='layer7')
plt.plot(m7base3T[7], label='layer8')
plt.title('VGS+, average ',size=14)  
plt.xticks([0,1,2,3,4],['5', '15', '25','35','45'])
plt.grid()
plt.legend(fontsize=14) 
...
plt.subplot(3, 4, 9)  
plt.plot(m7ver4[0][0:5], label='layer1')
plt.plot(m7ver4[1][0:5], label='layer2')
plt.plot(m7ver4[2][0:5], label='layer3')
plt.plot(m7ver4[3][0:5], label='layer4')
plt.plot(m7ver4[4][0:5], label='layer5')
plt.plot(m7ver4[5][0:5], label='layer6')
plt.plot(m7ver4[6][0:5], label='layer7')
plt.plot(m7ver4[7][0:5], label='layer8')
...
plt.subplot(3, 4, 10)  
plt.plot(m7ver4[0][4:], label='layer1')
plt.plot(m7ver4[1][4:], label='layer2')
plt.plot(m7ver4[2][4:], label='layer3')
plt.plot(m7ver4[3][4:], label='layer4')
plt.plot(m7ver4[4][4:], label='layer5')
plt.plot(m7ver4[5][4:], label='layer6')
plt.plot(m7ver4[6][4:], label='layer7')
plt.plot(m7ver4[7][4:], label='layer8')
plt.title('VGS+ pretrained, average ',size=14)  
plt.xlabel('epoch', size=18)
plt.xticks([0,1,2,3,4],['5', '15', '25','35','45'])
plt.grid()
