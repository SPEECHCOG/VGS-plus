...
m7ver4T = (np.reshape(scores_m7ver4T, (10,9))).T
...
x_abx_m7base1 = [0.,5,10,15,20,25,35,45]
y_abx_m7base1 = []
...
abx_v8 = [ ((item - min_abx) / delta_abx) for item in y_abx_m7ver8]
...
plt.plot(x_abx_m7ver8, abx_v8 ,c_3 , label='w2v2 Pre VGS+')
...
kh
savemat(path_save + "lex_l0.mat", dict_recall)
