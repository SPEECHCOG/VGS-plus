...
plt.plot(x_7ver5_recall, y_7ver5_recall, c_1, label = '5T')
kh
...
dict_recall = {}
dict_recall['VGS-plus-pre'] = {}
dict_recall['VGS-plus-pre']['x'] = x_7ver4T_recall
dict_recall['VGS-plus-pre']['y'] = y_7ver4T_recall


dict_recall['VGS-plus-0.5'] = {}
dict_recall['VGS-plus-0.5']['x'] = x_7base3T_recall
dict_recall['VGS-plus-0.5']['y'] = y_7base3T_recall

dict_recall['VGS-plus-0.1'] = {}
dict_recall['VGS-plus-0.1']['x'] = x_7base4T_recall
dict_recall['VGS-plus-0.1']['y'] = y_7base4T_recall

dict_recall['VGS-plus-0.9'] = {}
dict_recall['VGS-plus-0.9']['x'] = x_7base5T_recall
dict_recall['VGS-plus-0.9']['y'] = y_7base5T_recall

savemat("average-recall.mat", dict_recall)
